...
import { oberlevPlugin } from './plugin/index';
...
export const eslint: Eslint = (inputOptions = {} as EslintOptions, ...configs) => {
  ...
  if (jsxA11y) {
    ...
    configs.unshift({
      name: 'oberlev/jsx-a11y',
      plugins: {
        'oberlev-jsx-a11y': pluginJsxA11y
      },
      rules: {
        ...Object.entries(jsxA11yRules).reduce<Linter.RulesRecord>((acc, [key, value]) => {
          acc[key.replace('jsx-a11y', 'oberlev-jsx-a11y')] = value;
          return acc;
        }, {})
      }
    });
  ...
  if (playwright) {
    ...
    configs.unshift({
      name: 'oberlev/playwright',
      ...(typeof playwright === 'object' && { files: playwright.patterns }),
      plugins: {
        'oberlev-playwright': pluginPlaywright
      },
      rules: {
        ...Object.entries(playwrightRules).reduce<Linter.RulesRecord>((acc, [key, value]) => {
          acc[key.replace('playwright', 'oberlev-playwright')] = value;
          return acc;
        }, {}),
        'oberlev-playwright/expect-expect': 'off'
      }
    });
  }
  ...
  if (tailwind) {
    ...
    configs.unshift({
      name: 'oberlev/tailwind',
      plugins: {
        'oberlev-tailwind': pluginBetterTailwindcss
      },
      rules: {
        ...Object.entries(tailwindRules).reduce<Linter.RulesRecord>((acc, [key, value]) => {
          acc[key.replace('better-tailwindcss', 'oberlev-tailwind')] = value;
          return acc;
        }, {}),
        'oberlev-tailwind/enforce-consistent-line-wrapping': 'off'
      },
      settings: {
        'better-tailwindcss': {
  ...
  configs.unshift({
    name: 'oberlev',
    plugins: {
      oberlev: oberlevPlugin
    },
    rules: {
      'oberlev/function-component-definition': [
        'error',
        {
